...
public class PieChartActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    private long today;
    //心情
    public int moodResult01 = sqlReturn.moodResult01;
    public int moodResult02 = sqlReturn.moodResult02;
    public int moodResult03 = sqlReturn.moodResult03;
    public int moodResult04 = sqlReturn.moodResult04;
    public int moodResult05 = sqlReturn.moodResult05;
    //主題
    public int tagResult01 = sqlReturn.tagResult01;
    public int tagResult02 = sqlReturn.tagResult02;
    public int tagResult03 = sqlReturn.tagResult03;
    public int tagResult04 = sqlReturn.tagResult04;
    public int tagResult05 = sqlReturn.tagResult05;
    String d1;
    String d2;
    PieChart pieChart;
...
//        map.put("uid", uid);
    ...
    private static class mood_statistics extends HttpURLConnection_AsyncTask {
        // 建立弱連結
        ...
        protected void onPostExecute(String result) {
            ...
            // 取得弱連結的Context
            PieChartActivity activity = (PieChartActivity) activityReference.get();
            ...
            try {
                ...
                if(status){
                    ...
                    activity.moodResult01 = sqlReturn.moodResult01;
                    activity.moodResult02 = sqlReturn.moodResult02;
                    activity.moodResult03 = sqlReturn.moodResult03;
                    activity.moodResult04 = sqlReturn.moodResult04;
                    activity.moodResult05 = sqlReturn.moodResult05;
                    Log.d("mood1", String.valueOf(activity.moodResult01));
...
//                    if(tagResult01 == 0 && tagResult02 == 0 && tagResult03 == 0 && tagResult04 ==0 && moodResult05 == 0){
                    //心情
                    if(activity.moodResult01 == 0 && activity.moodResult02 == 0 && activity.moodResult03 == 0 && activity.moodResult04 ==0 && activity.moodResult05 == 0){
                        // 資料不足
                        activity.findViewById(R.id.suggestion).setVisibility( View.INVISIBLE );
                        activity.findViewById(R.id.recommend).setVisibility( View.INVISIBLE );
                        activity.findViewById(R.id.pie_chart).setVisibility( View.INVISIBLE );
                        activity.findViewById(R.id.statistics__no_text_1).setVisibility( View.VISIBLE );
                        activity.findViewById(R.id.statistics__no_text_2).setVisibility( View.VISIBLE );
                        activity.findViewById(R.id.statistics_no).setVisibility( View.VISIBLE );
                    }else {
                        activity.findViewById(R.id.suggestion).setVisibility( View.VISIBLE );
                        activity.findViewById(R.id.recommend).setVisibility( View.VISIBLE );
                        activity.findViewById(R.id.pie_chart).setVisibility( View.VISIBLE );
                        activity.findViewById(R.id.statistics__no_text_1).setVisibility( View.INVISIBLE );
                        activity.findViewById(R.id.statistics__no_text_2).setVisibility( View.INVISIBLE );
                        activity.findViewById(R.id.statistics_no).setVisibility( View.INVISIBLE );
    ...
    private static class tag_statistics extends HttpURLConnection_AsyncTask{
        // 建立弱連結
        WeakReference<Activity> activityReference;
        tag_statistics(Activity context){
            activityReference = new WeakReference<>(context);
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(status){
                    ...
                    activity.tagResult01 = sqlReturn.tagResult01;
                    activity.tagResult02 = sqlReturn.tagResult02;
                    activity.tagResult03 = sqlReturn.tagResult03;
                    activity.tagResult04 = sqlReturn.tagResult04;
                    activity.tagResult05 = sqlReturn.tagResult05;
                }else {
                    Toast.makeText(activity, "失敗", Toast.LENGTH_LONG).show();
                }
            }catch (JSONException e){
